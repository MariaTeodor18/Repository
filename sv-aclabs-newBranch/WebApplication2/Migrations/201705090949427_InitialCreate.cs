namespace WebApplication2.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        upgradeCounter = c.Int(nullable: false),
                        UpgradeCompletion = c.DateTime(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Cities", "ApplicationUserId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Cities", new[] { "ApplicationUserId" });
